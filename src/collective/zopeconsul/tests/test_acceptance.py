...
from collective.zopeconsul import taskqueue
from collective.zopeconsul.config import HAS_REDIS
from collective.zopeconsul.config import HAS_MSGPACK
from collective.zopeconsul.config import HAVE_PLONE_5
from collective.zopeconsul.testing import TASK_QUEUE_ZSERVER_FIXTURE
from collective.zopeconsul.testing import REDIS_TASK_QUEUE_ZSERVER_FIXTURE
from collective.zopeconsul.testing import ZSERVER_FIXTURE
...
class TaskQueueFormLayer(PloneSandboxLayer):
    ...
    def setUpZope(self, app, configurationContext):
        #import collective.zopeconsul.pasplugin
        #xmlconfig.file('configure.zcml',
        #               collective.zopeconsul.pasplugin,
        #               context=configurationContext)
        #z2.installProduct(app, 'collective.zopeconsul.pasplugin')
        ...
        import collective.zopeconsul.tests
        xmlconfig.file('test_acceptance.zcml',
                       collective.zopeconsul.tests,
                       context=configurationContext)
    ...
    def setUpPloneSite(self, portal):
        ...
        #self.applyProfile(portal, 'collective.zopeconsul.pasplugin:default')
